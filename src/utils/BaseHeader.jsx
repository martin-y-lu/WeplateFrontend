...
const BaseHeader = (props) =>{
    const {options} = props
    const {opacity,color } = options.headerTitleStyle
    return <View style = {{ backgroundColor:`rgba(255,255,255,${Math.floor(opacity*255)})`,shadowColor:"black",shadowRadius:5,shadowOpacity:0.5*opacity}}>
