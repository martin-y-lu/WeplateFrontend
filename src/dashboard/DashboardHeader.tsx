    ...
    return  <BaseHeader {...props}>
        <View style = {{
            ...
            <View style = {{
                ...
                <BubbleButton text = "Breakfast" highlighted/>
                <BubbleButton text = "Lunch" />
                <BubbleButton text = "Dinner" />
            </View>
        </View>
         {/* <View style= {{
                flex:1,
